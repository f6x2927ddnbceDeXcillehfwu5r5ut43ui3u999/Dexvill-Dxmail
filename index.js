    ...
    if (!message.guild) {
        ...
        if (!main) {
            ...
            let sembed = new discord.MessageEmbed()
                ...
                .setColor("GREEN")
                .setThumbnail(client.user.displayAvatarURL())
                .setDescription("Conversation is now started, you will be contacted by staff ASAP.")
            ...
            let eembed = new discord.MessageEmbed()
                ...
                .addField("By GATC", "[Gaming Around The Clock server](https://discord.gg/Cdcy3fFtMB)")
